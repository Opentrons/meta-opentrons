...
SYSTEMD_SERVICE_${PN} = "var.mount etc.mount home.mount partition.service"
...
"
FILES_${PN} += "${systemd_unitdir}/system/var.mount ${systemd_unitdir}/system/etc.mount ${systemd_unitdir}/system/home.mount ${systemd_unitdir}/system/partition.service ${sbindir}/setup-partition.sh"
...
do_install_append() {
  ...
  install -m 0644 ${WORKDIR}/etc.mount ${D}/${systemd_unitdir}/system
